...
import { FileText, Search, Filter, Download, X, User, Mail, Phone, Calendar, DollarSign, Tag, Trash2, UserPlus, Eye, Send, MessageSquare } from 'lucide-react';
                  ...
                  <TableRow key={script.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        ...
                        {/* Review button will be shown once review system is set up */}
                        <Button
                          size="sm"
                          variant="destructive"
                ...
                <Card className="bg-portfolio-black border-portfolio-gold/30">
                  ...
                  <CardContent>
                    ...
                    {selectedScript.file_url && (
                      <Button
                        size="sm"
                        className="mt-3 bg-portfolio-gold text-black hover:bg-portfolio-gold/90"
