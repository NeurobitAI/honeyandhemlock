        ...
        <Card className="bg-portfolio-dark border-portfolio-gold/20">
          <CardHeader className="text-center pb-2">
            <div className="w-16 h-16 bg-portfolio-gold rounded-full flex items-center justify-center mx-auto mb-4">
              <Gavel className="w-8 h-8 text-portfolio-black" />
            </div>
            <CardTitle className="text-portfolio-gold text-2xl">Judge Login</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="judge@honeyandhemlock.productions"
